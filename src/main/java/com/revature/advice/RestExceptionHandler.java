...
public class RestExceptionHandler {
  ...
  public ResponseEntity<Object> handleExpiredRequestException(
    HttpServletRequest request,
    ExpiredRequestException exception
  ) {
    String errorMessage =
      "The password reset request expired. Please try again. Links expire in 24 hours.";
