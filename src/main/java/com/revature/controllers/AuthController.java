...
@RequestMapping("/auth")
@CrossOrigin(
  origins = "http://2205java-sre-p3.s3-website-us-east-1.amazonaws.com/",
...
public class AuthController {
  ...
  public ResponseEntity<User> login(
    ...
    Optional<User> optionalUser = authService.findByCredentials(
  ...
  public User responseEntity(
    @RequestBody ResetRequestPassword password,
    @PathVariable("requestId") int id
  )
    throws ExpiredRequestException {
