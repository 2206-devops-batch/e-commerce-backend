...
public class ResetRequestRegistationTests {
  ...
  void findEmailRepositoryTest() {
    Assertions.assertTrue(
      userRepository.findByEmail("testuser@gmail.com").isPresent()
    );
  }
  ...
  void findEmailServiceTest() {
    Assertions.assertTrue(
      userService.findByEmail("testuser@gmail.com").isPresent()
    );
  }
  ...
  void resetPassword() {
    ...
    Assertions.assertEquals(
      User.encryptPassword("resetTest", user.getSaltBytes()),
      user.getPassword()
    );
  }
  ...
  void ResetPassword() {
    ...
    Assertions.assertThrows(
      (ExpiredRequestException.class),
      () -> authService.resetPassword("resetTest", 1)
    );
  }

  @Test
  void negativeResetPassword() {
    Optional<ResetRequest> request = passwordRepository.findById(1);
