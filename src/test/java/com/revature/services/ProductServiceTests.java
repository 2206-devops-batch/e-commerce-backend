  ...
  void find_by_name_or_description() {
      ...
      .forEach(
        p ->
          Assertions.assertTrue(
            p.getDescription().toLowerCase().contains("ba") ||
            p.getName().toLowerCase().contains("ba")
          )
      );
    ...
    retrieved
      ...
      .forEach(
        p ->
          Assertions.assertTrue(
            p.getDescription().toLowerCase().contains("nice") ||
            p.getName().toLowerCase().contains("nice")
          )
      );
  }
